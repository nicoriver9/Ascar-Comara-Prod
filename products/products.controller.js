...
let ProductsController = class ProductsController {
    ...
    async create(createProductDto, userId, categoryId) {
        return await this.productsService.create(createProductDto, userId, categoryId);
    }
    async findAll() {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_product_dto_1.CreateProductDto, Number, Number]),
